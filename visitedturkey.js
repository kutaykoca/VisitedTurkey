...
function downloadMap() {
  ...
  html2canvas(div).then(function (canvas) {
    ...
    ctx.fillStyle = "black";
    ctx.textAlign = "start";
    var textWidth = ctx.measureText("kutaykoca.github.io/visitedturkey");
    ctx.fillText("kutaykoca.github.io/visitedturkey", 10, canvas.height - 25);
    ctx.fillText(cityCount + "/81", 10, 5);

    destCanvas.toBlob(function (blob) {
      saveAs(blob, "visitedturkey.png");
    });
  });
}
